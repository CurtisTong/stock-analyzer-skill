...
class TestEarningsQualityScore:
    def test_positive_eps(self):
        ...
        fin = {"net_margin": 20, "roe": 15, "debt_ratio": 30, "ocf_per_share": 2.0, "eps": 2.0}
...
class TestRedFlagScore:
    def test_clean_company(self):
        ...
        fin = {"goodwill": 0, "total_assets": 100, "short_term_loan": 5,
               "long_term_loan": 3, "cash": 20, "revenue": 50,
               "net_profit": 5, "ocf": 6, "related_transaction": 2}
        score = _a_stock_red_flag_score(fin)
        assert score >= 0

    def test_red_flags(self):
        from strategies.factors.quality import _a_stock_red_flag_score
        fin = {"goodwill": 80, "total_assets": 100, "short_term_loan": 50,
               "long_term_loan": 30, "cash": 5, "revenue": 10,
               "net_profit": 1, "ocf": -5}
        score = _a_stock_red_flag_score(fin)
...
class TestQualityScore:
    def test_overall(self):
        ...
        fin = {"eps": 2.0, "roe": 15, "net_margin": 20, "debt_ratio": 30,
               "ocf_per_share": 2.0, "goodwill": 5, "total_assets": 100,
