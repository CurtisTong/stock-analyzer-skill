...
def _make_records(prices, base_day="2025-01-01"):
    ...
    for i, p in enumerate(prices):
        ...
        records.append({
            "day": day, "open": p, "high": p * 1.01, "low": p * 0.99,
...
class TestLimitAnalysisBasic:
    ...
    def test_insufficient_data_returns_none(self):
        ...
        result = astock.limit_analysis(records, "主板", {"limit_up": 11, "limit_down": 9})
    ...
    def test_normal_trading(self):
        ...
        result = astock.limit_analysis(records, "主板", {
    ...
    def test_sealed_down(self):
        ...
        result = astock.limit_analysis(records, "主板", {
            "limit_up": 10.95, "limit_down": 9.05
        })
