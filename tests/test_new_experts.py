...
class TestRiskManager:
    ...
    def test_extreme_greed_warning(self):
        ...
        result = risk_manager.score({
            ...
            "market_features": {
                ...
                "advance_ratio": 0.85, "nh_nl_ratio": 2.0,
            },
        })
        assert result["情绪"] <= 40
    ...
    def test_extreme_fear_warning(self):
        ...
        result = risk_manager.score({
            ...
            "finance": {},
            "market_features": {
                "limit_up_count": 5, "limit_down_count": 80,
                "advance_ratio": 0.15, "nh_nl_ratio": 0.2,
            },
        })
        assert result["情绪"] <= 40
    ...
    def test_neutral_market(self):
        ...
        result = risk_manager.score({
            ...
            "finance": {},
            "market_features": {
                "limit_up_count": 40, "limit_down_count": 30,
                "advance_ratio": 0.5, "nh_nl_ratio": 1.0,
            },
        })
