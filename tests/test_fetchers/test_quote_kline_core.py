...
from fetchers.chip.eastmoney_chip import MarginFetcher, HolderFetcher
...
class TestSinaQuoteFetcher:
    ...
    @patch("fetchers.quote.sina_quote.http_get_with_headers")
...
class TestEastmoneyKlineFetcher:
    ...
    @patch("fetchers.kline.eastmoney_kline.http_get")
...
class TestLhbFetcher:
    ...
    @patch("fetchers.lhb.eastmoney_lhb.http_get")
...
class TestMarginFetcher:
    ...
    @patch("fetchers.chip.eastmoney_chip.http_get")
...
class TestEastmoneyFinanceFetcher:
    ...
    @patch("fetchers.finance.eastmoney_finance.http_get")
...
class TestTencentQuoteExtra:
    ...
    @patch("fetchers.quote.tencent_quote.http_get")
