...
from experts.scoring import (
    ...
    buffett, duan_yongping, xu_xiang, zhao_laoge, chaogu_yangjia, zuoshou_xinyi,
)
...
class TestWeightedMerge:
    ...
    def test_weights_normalized(self):
        ...
        result = weighted_merge([
            {"基本面": 80},
            {"基本面": 60},
        ], weights=[2.0, 2.0])  # 等权，归一化后 0.5/0.5
...
class TestTopicLeader:
    ...
    def sample_data(self):
        return {
            ...
            "market_features": {
                ...
                "advance_ratio": 0.7, "nh_nl_ratio": 1.5,
            },
            "kline_data": {"closes": [10, 11, 12, 13, 14], "volumes": [100, 120, 150, 180, 200]},
        }
    ...
    def test_matches_weighted_average(self, sample_data):
        ...
        for dim in xx_score:
            if dim in zl_score:
                expected = round(xx_score[dim] * 0.5 + zl_score[dim] * 0.5, 1)
    ...
    def sample_data(self):
        return {
            ...
            "market_features": {
                ...
                "advance_ratio": 0.5, "nh_nl_ratio": 0.8,
            },
            "kline_data": {"closes": [15, 14, 13, 12, 11], "volumes": [100, 200, 300, 400, 500]},
        }
    ...
    def test_matches_weighted_average(self, sample_data):
        ...
        for dim in cyj_score:
            if dim in zsxy_score:
                expected = round(cyj_score[dim] * 0.5 + zsxy_score[dim] * 0.5, 1)
