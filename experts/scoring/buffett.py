...
def score_with_reasoning(stock_data: dict) -> Dict[str, object]:
    ...
    dimensions["基本面"] = {"score": base, "weight": 0.42, "reason": reason}
    ...
    dimensions["估值"] = {"score": val, "weight": 0.28, "reason": val_reason}
    ...
    dimensions["技术面"] = {"score": tech, "weight": 0.05, "reason": tech_reason}
    ...
    dimensions["情绪"] = {"score": sent, "weight": 0.05, "reason": sent_reason}
    ...
    dimensions["安全边际"] = {"score": margin, "weight": 0.20, "reason": margin_reason}

    return {
        "scores": {"基本面": base, "估值": val, "技术面": tech, "情绪": sent, "安全边际": margin},
        "reasoning": reasoning,
...
def format_reasoning(result: dict) -> str:
    ...
    # 计算加权总分
    weights = {"基本面": 0.42, "估值": 0.28, "技术面": 0.05, "情绪": 0.05, "安全边际": 0.20}
