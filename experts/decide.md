...
| **极度恐慌/冰点** | 跌停>50家连续2日 + 炸板率>60%         | 50%      | 50%      | 段永平、养家、索罗斯     |
...
- 巴菲特评分≤39（看空）→ 仅在中长期投资（≥1月）模式下生效，最终方向至少降一级；短期操作模式下巴菲特评分仅供参考
- 养家评分<30 → 短线组所有评分额外×0.7（仅评分降权，不影响仓位上限；退潮期应降低仓位上限而非降低评分）
...
```
一致性分 = 100 - (8人评分的标准差 × 10)  # 标准差越小→越一致
