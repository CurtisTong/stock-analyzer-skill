...
│  ├── /sector - 板块分析                                            │
│  ├── /portfolio - 持仓管理                                         │
│  ├── /portfolio-web - Web 录入                                   │
│  ├── /portfolio-natural - 自然语言持仓                               │
│  ├── /screener - 选股筛选                                          │
│  ├── /backtest - 策略回测                                          │
│  ├── /research - 深度研究                                          │
│  ├── /learn - 学习助手                                             │
...
- 健康检查命令：`python3 scripts/monitor.py`
- 数据源状态实时监控
- 缓存统计信息
...
> 完整历史变更记录见 [CHANGELOG.md](../CHANGELOG.md)；规划详情见 [archive/designs/implementation-plan-2026-q3-q4.md](archive/designs/implementation-plan-2026-q3-q4.md)。
