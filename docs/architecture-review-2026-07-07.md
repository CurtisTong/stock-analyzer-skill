...
> v2.4.0 合并 value_anchor+institution 为 value_institution 后，active 集校正为 **8 人（5 长线 + 3 短线）**。
> 本报告中的"9 人/6 长线"表述保留为历史记录，以代码 `list_active_experts()` 为准。
...
9 位 active 专家名义上提供 9 个独立视角，但实际上存在严重的观点相关性：
